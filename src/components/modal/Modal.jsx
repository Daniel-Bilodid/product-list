...
function Modal({ cartItems, total, isModalOpen, setIsModalOpen }) {
  function modalClose() {
  ...
  return (
    <>
      <div
        className={isModalOpen ? "overlay overlay__active" : "overlay"}
      ></div>
      <div className={isModalOpen ? "modal modal__active" : "modal"}>
        <div className="modal__wrapper">
          ...
          <div className="modal__text">
            <div className="modal__text-order">Order Confirmed</div>
            <div className="modal__text-descr">
          ...
          <div className="modal__information">
                      ...
                      <div className="wrapper">
                        ...
                        <div className="cart__text-wrapper">
                          <div className="cart__text-amount">
                            <div className="cart__text-count">
                              {item.count}x
                            </div>
                            <div className="cart__text-oldprice">
                              @${item.price}
                            </div>
                          </div>
                        </div>
            ...
            <div className="cart__order">
              ...
              <div className="cart__order-total">${total} </div>
            </div>
          </div>
